...
const routes = [
    {
        ...
        children: [
            ...
            //     path: "/processchoice",
            //     name: "processchoice",
            //     component: () => import(/* webpackChunkName: "resetpassword" */ "../views/ProcessBill/ProcessChoice.vue"),
            // },
            // {
            //     path: "/process-selectitem/:PDProcess",
            //     name: "process-selectitem",
            //     params: true,
            //     component: () => import(/* webpackChunkName: "resetpassword" */ "../views/ProcessBill/ProcessSelectItem.vue"),
            // },
            {
                path: "/process-create-bill",
                name: "process-create-bill",
                params: true,
                component: () => import(/* webpackChunkName: "resetpassword" */ "../views/ProcessBill/CreateProcesBill.vue"),
            },
            {
                path: "/process-verifybill",
                name: "verifyBillProcess",
                params: true,
                component: () => import(/* webpackChunkName: "resetpassword" */ "../views/ProcessBill/verifyBillProcess.vue"),
            },
            {
                path: "/receivebill-process-master",
                name: "receivebill-process-master",
                params: true,
                component: () => import(/* webpackChunkName: "resetpassword" */ "../views/ProcessBill/ReceiveBillProcessMaster.vue"),
            },
            {
                path: "/receivebill-process-detail",
                name: "receivebill-process-detail",
                params: true,
                component: () => import(/* webpackChunkName: "resetpassword" */ "../views/ProcessBill/ReceiveBillProcessDetail.vue"),
            },
            {
                path: "/invforordernew",
                name: "invforordernew",
                params: true,
                component: () => import(/* webpackChunkName: "resetpassword" */ "../views/OrderStatus/InvForOrderNew.vue"),
            },
            {
                path: "/invforproduct_new",
                name: "invforproduct_new",
                params: true,
                component: () => import(/* webpackChunkName: "resetpassword" */ "../views/OrderStatus/InvForProductNew.vue"),
            },
            {
                path: "/productfroinv",
                name: "productfroinv",
                params: true,
                component: () => import(/* webpackChunkName: "resetpassword" */ "../views/OrderStatus/ProductForInv.vue"),
            },
            {
                path: "/work-check",
                name: "work-check",
                params: true,
                component: () => import(/* webpackChunkName: "resetpassword" */ "../views/OrderStatus/WorkCheck"),
            },
            {
                path: "/statusnew",
                name: "statusnew",
                params: true,
                component: () => import(/* webpackChunkName: "resetpassword" */ "../views/OrderStatus/StatusNew.vue"),
            },
            {
                path: "/",
                name: "login",
